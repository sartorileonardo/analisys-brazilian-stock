package br.com.company.stock.core.validation

import br.com.company.stock.core.exception.BusinessException
...
class TickerValidation {
    ...
    private fun validarSeForVazio(ticker: String) =
        if (ticker.isNullOrBlank()) throw BusinessException("Ticker é obrigatório!") else true
}